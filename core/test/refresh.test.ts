...
test('updates posts', async () => {
  ...
  equal(refreshing.get(), false)
  equal(refreshingProgress.get(), undefined)
  deepStrictEqual(refreshingStatistics.get(), {
    errors: 0,
    foundFast: 0,
    foundSlow: 0,
    initializing: false,
  ...
  await setTimeout(10)
  equal(refreshingProgress.get(), 0)
  deepStrictEqual(refreshingStatistics.get(), {
    errors: 0,
    foundFast: 0,
    foundSlow: 0,
  ...
  await setTimeout(10)
  equal(refreshingProgress.get(), 0.5)
  deepStrictEqual(refreshingStatistics.get(), {
    errors: 0,
    foundFast: 0,
    foundSlow: 2,
  ...
  equal(finished, true)
  equal(refreshing.get(), false)
  equal(refreshingProgress.get(), 1)
  deepStrictEqual(refreshingStatistics.get(), {
    errors: 0,
    foundFast: 2,
    foundSlow: 3,
