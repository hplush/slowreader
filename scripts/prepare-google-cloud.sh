...
echo -e "5. Add \033[1mdev\033[0m.slowreader.app to staging-web"
echo -e "6. Add \033[1mdev-proxy\033[0m.slowreader.app to staging-proxy"
echo -e "7. Add \033[1mdev-server\033[0m.slowreader.app to staging-server"
echo -e "8. Check Cloud Run service internal URL like \033[1m*.run.app\033[0m"
echo -e "9. Set domain in \033[1m.github/workflows/preview-deploy.yml\033[0m"
