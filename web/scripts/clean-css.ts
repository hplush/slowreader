// Applies PostCSS plugins to clean each CSS file generated during the build.
// Displays errors generated by the plugin execution
...
const PLUGINS = [
  // Merge all rules with :root selector into the single rule
...
const cssCleaner = postcss(PLUGINS)
